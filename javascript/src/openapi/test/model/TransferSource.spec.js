...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WaaSOpenApiDocumentation.TransferSource();
  });
  ...
  describe('TransferSource', function() {
    it('should create an instance of TransferSource', function() {
      ...
      //var instane = new WaaSOpenApiDocumentation.TransferSource();
      //expect(instance).to.be.a(WaaSOpenApiDocumentation.TransferSource);
    });

    it('should have the property address (base name: "address")', function() {
      // uncomment below and update the code to test the property address
      //var instance = new WaaSOpenApiDocumentation.TransferSource();
