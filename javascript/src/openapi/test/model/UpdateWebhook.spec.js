...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WaaSOpenApiDocumentation.UpdateWebhook();
  });
  ...
  describe('UpdateWebhook', function() {
    it('should create an instance of UpdateWebhook', function() {
      ...
      //var instane = new WaaSOpenApiDocumentation.UpdateWebhook();
      //expect(instance).to.be.a(WaaSOpenApiDocumentation.UpdateWebhook);
    });

    it('should have the property description (base name: "description")', function() {
      // uncomment below and update the code to test the property description
      //var instance = new WaaSOpenApiDocumentation.UpdateWebhook();
