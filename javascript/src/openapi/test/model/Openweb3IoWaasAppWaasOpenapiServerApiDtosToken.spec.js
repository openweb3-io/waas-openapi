...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WaaSOpenApiDocumentation.Openweb3IoWaasAppWaasOpenapiServerApiDtosToken();
  });
  ...
  describe('Openweb3IoWaasAppWaasOpenapiServerApiDtosToken', function() {
    it('should create an instance of Openweb3IoWaasAppWaasOpenapiServerApiDtosToken', function() {
      // uncomment below and update the code to test Openweb3IoWaasAppWaasOpenapiServerApiDtosToken
      //var instane = new WaaSOpenApiDocumentation.Openweb3IoWaasAppWaasOpenapiServerApiDtosToken();
      //expect(instance).to.be.a(WaaSOpenApiDocumentation.Openweb3IoWaasAppWaasOpenapiServerApiDtosToken);
    });
    ...
    it('should have the property canDeposit (base name: "can_deposit")', function() {
      ...
      //var instance = new WaaSOpenApiDocumentation.Openweb3IoWaasAppWaasOpenapiServerApiDtosToken();
