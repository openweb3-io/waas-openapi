...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WaaSOpenApiDocumentation.TransferDestination();
  });
  ...
  describe('TransferDestination', function() {
    it('should create an instance of TransferDestination', function() {
      ...
      //var instane = new WaaSOpenApiDocumentation.TransferDestination();
      //expect(instance).to.be.a(WaaSOpenApiDocumentation.TransferDestination);
    });

    it('should have the property address (base name: "address")', function() {
      // uncomment below and update the code to test the property address
      //var instance = new WaaSOpenApiDocumentation.TransferDestination();
