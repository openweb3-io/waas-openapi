...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WaaSOpenApiDocumentation.CursorPageWebhook();
  });
  ...
  describe('CursorPageWebhook', function() {
    it('should create an instance of CursorPageWebhook', function() {
      // uncomment below and update the code to test CursorPageWebhook
      //var instane = new WaaSOpenApiDocumentation.CursorPageWebhook();
      //expect(instance).to.be.a(WaaSOpenApiDocumentation.CursorPageWebhook);
    });
    ...
    it('should have the property hasNext (base name: "has_next")', function() {
      ...
      //var instance = new WaaSOpenApiDocumentation.CursorPageWebhook();
