...
export class PromiseGasStationsApi {
     ...
     */
    public v1GasStationsGetOrCreateDepositAddressWithHttpInfo(chainId: string, walletId?: string, _options?: Configuration): Promise<HttpInfo<GetGasStationDepositAddressReply>> {
     ...
     * @param walletId Wallet ID
     */
    public v1GasStationsGetOrCreateDepositAddress(chainId: string, walletId?: string, _options?: Configuration): Promise<GetGasStationDepositAddressReply> {
...
export class PromiseTransactionsApi {
     ...
     * @param limit The number of records to return default: 20
     */
    public v1TransactionsList(walletIds?: Array<string>, chainIds?: Array<string>, tokenIds?: Array<string>, assetIds?: Array<string>, hash?: string, status?: 'Submitted' | 'PendingSignature' | 'Failed' | 'Broadcasting' | 'Confirming' | 'Completed', cursor?: string, limit?: number, _options?: Configuration): Promise<CursorPageTransaction> {
