...
class CursorPageWallet {
    ...
    /**
     * Validates the JSON data with respect to <code>CursorPageWallet</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CursorPageWallet</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CursorPageWallet.RequiredProperties) {
...
CursorPageWallet.RequiredProperties = ["has_next", "has_prev", "items", "total"];
