...
class CursorPageToken {
    ...
    /**
     * Validates the JSON data with respect to <code>CursorPageToken</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CursorPageToken</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CursorPageToken.RequiredProperties) {
...
CursorPageToken.RequiredProperties = ["has_next", "has_prev", "items", "total"];
