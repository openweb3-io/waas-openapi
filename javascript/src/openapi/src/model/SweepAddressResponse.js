...
/**
 * The SweepAddressResponse model module.
 * @module model/SweepAddressResponse
 * @version 1.0
 */
class SweepAddressResponse {
    ...
    /**
     * Constructs a <code>SweepAddressResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SweepAddressResponse} obj Optional instance to populate.
     * @return {module:model/SweepAddressResponse} The populated <code>SweepAddressResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SweepAddressResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>SweepAddressResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
 ...
 * @member {String} tx_id
 */
SweepAddressResponse.prototype['tx_id'] = undefined;
...
export default SweepAddressResponse;
