...
public class ChainsApi {
     ...
     */
    public okhttp3.Call v1ChainsRetrieveCall(String id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1/chains/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call v1ChainsRetrieveValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling v1ChainsRetrieve(Async)");
        }
        

        okhttp3.Call localVarCall = v1ChainsRetrieveCall(id, _callback);
        return localVarCall;
