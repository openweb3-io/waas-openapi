...
public class ApiClient {
     ...
     */
    public RequestBody serialize(JSON jsonSerializer, Object obj, String contentType) throws ApiException {
        ...
        for (int retry = 0; retry < numRetries; retry++) {
            try {
                try {
                    ...
                    if (response.code() < 500 || retry >= numRetries - 1) {
                ...
                if (e.getCode() < 500 || retry >= numRetries -1) {
                    throw e;
                }
            }
            try {
    ...
    public Request buildRequest(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
        ...
        if (!HttpMethod.permitsRequestBody(method)) {
            ...
            reqBody = serialize(patchJson, body, contentType); 
        } else {
            reqBody = serialize(json, body, contentType);
        }
