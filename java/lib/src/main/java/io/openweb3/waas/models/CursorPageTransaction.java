...
public class CursorPageTransaction {
  ...
  public CursorPageTransaction hasPrev(Boolean hasPrev) {
  ...
  public CursorPageTransaction total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hasNext, cursorPageTransaction.hasNext) &&
        Objects.equals(this.hasPrev, cursorPageTransaction.hasPrev) &&
        ...
        Objects.equals(this.total, cursorPageTransaction.total);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CursorPageTransaction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CursorPageTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CursorPageTransaction is not found in the empty JSON string", CursorPageTransaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CursorPageTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CursorPageTransaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CursorPageTransaction.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        Transaction.validateJsonElement(jsonArrayitems.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CursorPageTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CursorPageTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CursorPageTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CursorPageTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<CursorPageTransaction>() {
           @Override
           public void write(JsonWriter out, CursorPageTransaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CursorPageTransaction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CursorPageTransaction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CursorPageTransaction
   * @throws IOException if the JSON string is invalid with respect to CursorPageTransaction
   */
  public static CursorPageTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CursorPageTransaction.class);
  }

  /**
   * Convert an instance of CursorPageTransaction to an JSON string
   *
   * @return JSON string
   */
