...
// checks if the CursorPageToken type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageToken{}
...
type _CursorPageToken CursorPageToken
...
func (o CursorPageToken) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageToken) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageToken := _CursorPageToken{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCursorPageToken)

	if err != nil {
		return err
	}

	*o = CursorPageToken(varCursorPageToken)
