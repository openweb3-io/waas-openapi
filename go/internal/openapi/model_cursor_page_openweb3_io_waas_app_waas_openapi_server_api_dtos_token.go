...
// CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken struct for CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken
type CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken struct {
	HasNext bool `json:"has_next"`
	Items []Openweb3IoWaasAppWaasOpenapiServerApiDtosToken `json:"items"`
...
func NewCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken(hasNext bool, items []Openweb3IoWaasAppWaasOpenapiServerApiDtosToken) *CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken {
	this := CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken{}
...
func (o *CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken) GetItems() []Openweb3IoWaasAppWaasOpenapiServerApiDtosToken {
	if o == nil {
		var ret []Openweb3IoWaasAppWaasOpenapiServerApiDtosToken
		return ret
	}
...
func (o CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken) MarshalJSON() ([]byte, error) {
...
type NullableCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken struct {
	value *CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken
	isSet bool
}

func (v NullableCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken) Get() *CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken {
	return v.value
}

func (v *NullableCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken) Set(val *CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken) {
	v.value = val
	v.isSet = true
}

func (v NullableCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken) IsSet() bool {
	return v.isSet
}

func (v *NullableCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken(val *CursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken) *NullableCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken {
	return &NullableCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken{value: val, isSet: true}
}

func (v NullableCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCursorPageOpenweb3IoWaasAppWaasOpenapiServerApiDtosToken) UnmarshalJSON(src []byte) error {
	v.isSet = true
