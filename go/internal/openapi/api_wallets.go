...
func (r ApiV1WalletsDeleteRequest) Execute() (Wallet, *_nethttp.Response, error) {
 ...
 */
func (a *WalletsApiService) V1WalletsDelete(ctx _context.Context, walletId string) ApiV1WalletsDeleteRequest {
	return ApiV1WalletsDeleteRequest{
		ApiService: a,
		ctx: ctx,
		walletId: walletId,
 ...
 * @return Wallet
 */
func (a *WalletsApiService) V1WalletsDeleteExecute(r ApiV1WalletsDeleteRequest) (Wallet, *_nethttp.Response, error) {
	var (
