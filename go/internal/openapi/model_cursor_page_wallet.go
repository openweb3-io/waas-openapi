...
// checks if the CursorPageWallet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CursorPageWallet{}
...
type _CursorPageWallet CursorPageWallet
...
func (o CursorPageWallet) ToMap() (map[string]interface{}, error) {
...
func (o *CursorPageWallet) UnmarshalJSON(data []byte) (err error) {
	...
	varCursorPageWallet := _CursorPageWallet{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCursorPageWallet)

	if err != nil {
		return err
	}

	*o = CursorPageWallet(varCursorPageWallet)
